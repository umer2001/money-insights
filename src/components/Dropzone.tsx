...
const SUPPORTED_BANKS = [
  ...
  { key: "hbl", name: "Habib Bank (HBL)", color: "bg-emerald-500/10 text-emerald-700 border-emerald-500/20" },
  { key: "ubl", name: "United Bank (UBL)", color: "bg-cyan-500/10 text-cyan-600 border-cyan-500/20" },
  { key: "sadaPay", name: "SadaPay", color: "bg-teal-500/10 text-teal-600 border-teal-500/20" },
  { key: "easyPaisa", name: "easypaisa", color: "bg-green-500/10 text-green-600 border-green-500/20" },
